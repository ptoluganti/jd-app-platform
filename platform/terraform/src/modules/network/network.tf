...
# resource "azurerm_subnet_network_security_group_association" "mgt_nsg_association" {
#   subnet_id                 = azurerm_subnet.mgt.id
#   network_security_group_id = azurerm_network_security_group.mgt_nsg.id
# }

# # Create Network Security Group and rules
# resource "azurerm_network_security_group" "mgt_nsg" {
#   name                = "mgt-nsg"
#   location            = var.location
#   resource_group_name = var.resource_group_name
